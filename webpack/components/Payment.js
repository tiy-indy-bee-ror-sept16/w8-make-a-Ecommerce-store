...
class Payment extends Component {
    ...
    render(){
        return (
            <form action="replace with new route" method="post" enctype="multipart/form-data">
                            ...
                            <div className="panel-body">
                                <div className="row form-inline text-left">
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            <label forHTML="first_name">First Name &nbsp;<i className="fa fa-user" aria-hidden="true"></i></label>
                                            <input type="text" id="first_name" name="first_name" className="form-control" placeholder="First Name" maxlength="50" required />
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            <label forHTML="first_name">Last Name &nbsp;<i className="fa fa-user" aria-hidden="true"></i></label>
                                ...
                                <div className="row form-inline text-left">
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            <label forHTML="phone">Phone Number &nbsp;<i className="fa fa-phone" aria-hidden="true"></i></label>
                                            <input type="text" id="phone" name="phone" className="form-control" placeholder="(xxx)-(xxx)-(xxxx)" maxlength="10" required/>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            <label forHTML="email">Email &nbsp;<i className="fa fa-envelope" aria-hidden="true"></i></label>
                            ...
                            <div className="panel-body">
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="form-group">
                                            <label forHTML="street_name">Street &nbsp;<i className="fa fa-road" aria-hidden="true"></i></label>
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="form-group">
                                            <label forHTML="city_name">City</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <label forHTML="zip_code">Zip-Code</label>
                                            <input type="text" id="zip_code" name="zip-code" className="form-control" placeholder="(xxxxx)" maxlength="5"/>
                                        </div>
                                    </div>
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <label forHTML="country_ship">Country &nbsp;<i className="fa fa-globe" aria-hidden="true"></i></label>
                                            <select className="form-control" name="country_ship" id="country_ship">
                                                <option value="0" label="Select a country … " selected="selected">Select a country …       </option>
                                                <optgroup id="country-optgroup-Africa_ship" label="Africa">
                                                ...
                                                <optgroup id="country-optgroup-Americas_ship" label="Americas">
                                                ...
                                                <optgroup id="country-optgroup-Asia_ship" label="Asia">
                                                ...
                                                <optgroup id="country-optgroup-Europe_ship" label="Europe">
                                                ...
                                                <optgroup id="country-optgroup-Oceania_ship" label="Oceania">
                        ...
                        <div className="panel panel-success text-left">
                            ...
                            <div className="panel-body">
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="form-group">
                                            <label forHTML="street_name_bill">Street &nbsp;<i className="fa fa-road" aria-hidden="true"></i></label>
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="form-group">
                                            <label forHTML="city_name_bill">City</label>
                                ...
                                <div className="row">
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <label forHTML="state_bill">State</label>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <label forHTML="zip_code_bill">Zip-Code</label>
                                            <input type="text" id="zip_code_bill" name="zip-code_bill" className="form-control" placeholder="(xxxxx)" maxlength="5" required />
                                        </div>
                                    </div>
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <label forHTML="country_bill">Country &nbsp;<i className="fa fa-globe" aria-hidden="true"></i></label>
                        ...
                        <div className="panel panel-danger text-left">
                            ...
                            <div className="panel-body">
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="form-group">
                                            <label forHTML="card_number">Credit Card Number &nbsp;<i className="fa fa-credit-card-alt" aria-hidden="true"></i></label>
                                ...
                                <div className="row form-inline">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            <label forHTML="cvv_name">Card CVV &nbsp; <i className="fa fa-credit-card" aria-hidden="true"></i></label>
